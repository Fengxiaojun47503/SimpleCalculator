    ...
    companion object {
        ...
        val BUTTONS = arrayOf(
            listOf<Pair<Int, String>>(
                Pair(BUTTON_ID_CLEAR, BUTTON_TEXT_CLEAR.toString()),
            Pair(BUTTON_ID_DEL, BUTTON_TEXT_DEL.toString()),
                Pair(BUTTON_ID_PERCENT, BUTTON_TEXT_PERCENT.toString()),
            Pair(BUTTON_ID_DIV, BUTTON_TEXT_DIV.toString()),
            ),
            listOf<Pair<Int, String>>(
                Pair(BUTTON_ID_7, BUTTON_TEXT_7.toString()),
                Pair(BUTTON_ID_8, BUTTON_TEXT_8.toString()),
                Pair(BUTTON_ID_9, BUTTON_TEXT_9.toString()),
                Pair(BUTTON_ID_MUL, BUTTON_TEXT_MUL.toString()),
            ),
            listOf<Pair<Int, String>>(
                Pair(BUTTON_ID_4, BUTTON_TEXT_4.toString()),
                Pair(BUTTON_ID_5, BUTTON_TEXT_5.toString()),
                Pair(BUTTON_ID_6, BUTTON_TEXT_6.toString()),
                Pair(BUTTON_ID_MINUS, BUTTON_TEXT_MINUS.toString()),
            ),
            listOf<Pair<Int, String>>(
                Pair(BUTTON_ID_1, BUTTON_TEXT_1.toString()),
                Pair(BUTTON_ID_2, BUTTON_TEXT_2.toString()),
                Pair(BUTTON_ID_3, BUTTON_TEXT_3.toString()),
                Pair(BUTTON_ID_PLUS, BUTTON_TEXT_PLUS.toString()),
            ),
            listOf<Pair<Int, String>>(
                Pair(BUTTON_ID_0, BUTTON_TEXT_0.toString()),
                Pair(BUTTON_ID_DOT, BUTTON_TEXT_DOT.toString()),
                Pair(BUTTON_ID_EQUAL, BUTTON_TEXT_EQUAL.toString()),
            ),
        )
